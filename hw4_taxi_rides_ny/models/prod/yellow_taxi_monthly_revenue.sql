...
select 
    ...
    t1.ratecodeid, 
    {{ get_rate_code_id_description("t1.ratecodeid") }} as ratecode_category,
    t1.store_and_fwd_flag, 
    {{ get_store_fwd_flag_description("t1.store_and_fwd_flag") }} as store_type,
    t1.trip_type,
...
from {{ ref('yellow_monthly_zone_revenue') }} as t1
